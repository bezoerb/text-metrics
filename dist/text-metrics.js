...
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['module', './utils'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, require('./utils'));
    } else {
        var mod = {
            exports: {}
        };
    ...
    var TextMetrics = function () {
        function TextMetrics(el) {
            ...
            if (!(0, _utils.isElement)(el) && (0, _utils.isObject)(el)) {

                this.el = undefined;
                this.overwrites = (0, _utils.normalizeOptions)(el);
            } else {
                this.el = el;
                this.overwrites = (0, _utils.normalizeOptions)(overwrites);
            }

            this.style = (0, _utils.getStyle)(this.el, this.overwrites);
            this.font = (0, _utils.prop)(overwrites, 'font', null) || (0, _utils.getFont)(this.style, this.overwrites);
        }
        ...
        _createClass(TextMetrics, [{
            ...
            value: function width(text) {
                ...
                var styledText = (0, _utils.getStyledText)(text, this.style);

                var styles = _extends({}, this.overwrites, (0, _utils.normalizeOptions)(overwrites));
                var font = (0, _utils.getFont)(this.style, styles);

                var ctx = (0, _utils.getContext2d)(font);
            ...
            value: function height(text) {
                ...
                var lineHeight = parseInt((0, _utils.prop)(styles, 'line-height') || style.getPropertyValue('line-height'), 10);
            ...
            value: function lines(text) {
                ...
                // get max width
                var delimiter = (0, _utils.prop)(options, 'delimiter', ' ');
                var max = parseInt((0, _utils.prop)(options, 'width') || (0, _utils.prop)(overwrites, 'width') || (0, _utils.prop)(this.el, 'offsetWidth', 0) || this.style.getPropertyValue('width'), 10);
